...
class AboutWindow(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        about_text = "<p style='text-align: center;'>" + \
                ...
                <p style='text-align: center;'>
                <b>⭐ """ + \
                "Writing Tools would not be where it is today without its <u>amazing</u> contributors:</b><br>" + \
                "<b>1. <a href=\"https://github.com/momokrono\">momokrono</a>:</b><br>" + \
                "Added Linux support, switched to the pynput API to improve Windows stability. Added Ollama API support and core logic for customizable buttons. Fixed misc. bugs and added graceful termination support by handling SIGINT signal.<br>" + \
                ...
                'Helped add the start-on-boot setting.</b><br><br>' + \
                'This Linux edition is maintained at <a href="https://github.com/higajooj/WritingToolsLinux">WritingToolsLinux</a>.<br>' + \
                """</p>
                <p style='text-align: center;'>
